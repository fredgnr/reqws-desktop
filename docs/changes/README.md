...
| [GoLand 插件支持](goland-plugin-support/README.md) | active | 已选择自动同步项目模型、只读诊断 VCS 与用户手动维护 Directory Mappings 的产品契约；220 项插件测试和 261/262 Verifier 已通过，完整 GUI 矩阵仍待验收。 | 2026-08-18 |
