...
| [GoLand 插件支持](goland-plugin-support/README.md) | active | 已完成跨 IDE 契约、Desktop 入口与插件自动化实现；最新候选已通过 fresh 261/262 Plugin Verifier，verified atomic ownership 与 VCS 并发防护仍待 exact-candidate GUI 完整矩阵。 | 2026-08-18 |
