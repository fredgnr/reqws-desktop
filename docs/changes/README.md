...
| [GoLand 插件支持](goland-plugin-support/README.md) | active | 自动同步项目模型、只读诊断 VCS 的候选已补 stable directory writer lock、exact cancellation rollback 与首次启动有界自动恢复；281 项插件测试和 261/262 Verifier 通过，完整 GUI 矩阵仍待验收。 | 2026-08-30 |
