...
| [GoLand 插件支持](goland-plugin-support/README.md) | active | 远端可取得的 exact implementation commit 已通过 345 项插件测试和 261/262 Verifier；历史 GUI 缺陷仍待当前 ZIP 动态回归，完整 §8 未关闭，结论为 `NO-GO`。 | 2026-08-31 |
