...
S1/S2 已删除 `ReqwsGoModulesSynchronizer` 及其专属补偿、调度和 Go API 依赖，V 已完成。实际候选、命令、结果与 GUI 范围见 [2026-09-19 验收记录](../../ide-plugin-language-decoupling/testing/acceptance-2026-09-19.md)；本旧计划不再定义当前候选的执行门禁。

## 历史原文与结果

需要复核原验收时，阅读固定基线的[完整旧测试方案](https://github.com/fredgnr/reqws-desktop/blob/409b30e573d47348618620bbc0a52c0dd0710954/docs/changes/goland-plugin-support/testing/test-plan.md)和[原验证报告](verification-2026-09-13.md)。旧报告的结论与必要截图保留，完整过程记录通过 Git 历史查询；当前树不再维护源码输入 digest 清单，不改写历史 GO，也不继承它作为新版本 GO。
