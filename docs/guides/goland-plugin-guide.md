...
- 只读 VCS 当前源码候选的 GoLand 2026.1.3/2026.2 Plugin Verifier 均为 `Compatible`；本地 ZIP SHA-256 为 `d4ee9ee6352cf8a8c0ee3ca7e198fb37357f967ca881644dcd0c1790136b7652`（394,894 bytes）。真实 GUI/Go 功能仍待绑定推送后 exact commit 验收；旧候选证据不能继承。
