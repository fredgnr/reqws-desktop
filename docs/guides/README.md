...
| 文档 | 状态 | 说明 |
|---|---|---|
| [使用说明](user-guide.md) | active | 说明 Desktop 安装启动、个人签名版证书信任与更新、仓库配置、详情操作、数据保护和故障处理。 |
| [GoLand 插件使用指南](goland-plugin-guide.md) | active | 说明单目标插件安装、独立入口、加载选择与折叠操作、保存失败重试、用户 root 保护和排障；候选验证另见实施记录。 |
