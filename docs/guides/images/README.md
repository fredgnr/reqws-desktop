...
- 截图日期：2026-09-26。
- 界面源码：`review/code-humanizer-2026-09-21` 的 [bb11fa7](https://github.com/fredgnr/reqws-desktop/commit/bb11fa7bf64990a4a6bbdbfc134485d53a507e58)，使用原有 React 组件、样式和中文资源。
- 截取方式：Vite 本地 renderer 预览，通过内存中的 typed-API 形状示例提供仓库、工作区和编辑器可用性，再通过实际界面交互截取。没有使用真实 userData、个人仓库、Git 远端连接或 IDE 启动。
- 这些图片解释按钮和数据关系，不是 clone 成功、发布版自更新或 GoLand 插件同步的验收证据。设置图中的版本和“开发模式”提示来自该源码候选，不代表最新 Release。
